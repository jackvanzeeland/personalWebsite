...
export const PROJECTS: Project[] = [
  {
    ...
    originStory:
      "Growing up, I was raised to be financially responsible and learned the importance of budgeting early on. I started my journey in college.  I made an excel sheet to track my spending and categorize expenses.\n\nHowever, as my financial life became more complex and the tools available evolved, I wanted a more robust tool to manage my budget and visualize my spending patterns. I built this budget tracker to provide a comprehensive view of my finances, allowing me to see where my money was going and make informed decisions about my spending. By categorizing transactions and creating visualizations, I could easily identify trends and adjust my budget accordingly.\n\nThis project has been instrumental in helping me maintain financial discipline and achieve my savings goals.  Once I completed, I know some other friends and family that have asked about budget tracking, so I've made accounts for them to use the tool as well. It's been rewarding to see how this project has not only helped me but also others in my circle become more financially aware and responsible.",
  ...
  },
  {
    ...
    originStory:
      "I started trying to journal in the summer of 2025 after I graduated from college and was adjusting to a new life.  I would walk to the lake front with a journal and write about my day and how I was feeling.\n\nHowever this became a long process and I would have to plan out time to do it.  I wanted to build a journaling tool that would make it easy and seamless to capture my thoughts and feelings in the moment, without needing to set aside dedicated time for it.\n\nI built this journaling app to automatically capture contextual metadata like location, weather, and mood with each entry, creating a richer record of daily life. As an introspective person, I found that having this additional context helped me reflect on patterns in my life and better understand myself over time.",
  ...
  },
  {
    ...
    originStory:
      "For years I bounced between different notes and checklist apps but never found one that did exactly what I wanted — something fast, minimal, and always in my pocket with no unnecessary friction. I decided to just build my own.\n\nI wanted it to handle both structured checklists and freeform notes in the same place, with tagging, due dates, and search that actually worked across content.",
    technologies: ["Next.js", "TypeScript", "Turso"],
  ...
  },
  {
    ...
    originStory:
      "I noticed for myself if I am working out and I have my attention elsewhere other than the workout, I can get in a flow state and really enjoy it. I have recently been using Sudoku on the stair stepper at the gym.  When I first started, I struggled around 1000 stairs, 10 minutes, and easy mode of Sudoku. Since then I have become extremely familiar with the techniques of Sudoku and my go to workout is 2000 stairs, 20 minutes, and hard mode.\n\nThe first 'game' related project that I built was Wordle, so the obvious idea was to combine the two games that I enjoy into one. I built Woku to provide a fun and engaging way to challenge my mind while working out.\n\nBy combining the logic and pattern recognition of Sudoku with the word-guessing mechanics of Wordle, I created a unique game that keeps me mentally stimulated during my workouts. The game has been a great way to make exercise more enjoyable and has helped me stay motivated to maintain a consistent fitness routine.",
  ...
  },
  {
    ...
    description:
      "Created a system for a Super Bowl prop bet competition, where participants ranked their confidence in 20 prop outcomes. The tool validated confidence values, compared predictions to real results, and calculated each participant's score to determine the winner.",
    originStory:
      "In my sophomore year of college, I was getting more comfortable with Python and wanted to apply it to something I enjoyed. My friends and I are big football fans, and some of them are big bettors.  So when the Super Bowl came around in that year and our team (The Packers) weren't playing. I had an idea to create a prop bet competition to keep it interesting for us.\n\nIn the first couple years, I ran into a lot of issues regarding input validation and calculating scores, but I iterated on the design and built a robust system that made the competition more engaging and fun for everyone involved. The tool allowed us to easily track our predictions and see how we were doing throughout the game, adding an extra layer of excitement to the Super Bowl experience.",
  ...
  },
  {
    ...
    originStory:
      "For years growing up, my cousins and I would do a Secret Santa gift exchange during the holidays.  However, our original method was to pick a name out of a hat, just hoping that no one would pick themselves.  During my sophomore year of college, I wanted to create a more reliable and private way to do our Secret Santa matching.\n\nI built this program to ensure that no one would accidentally pick themselves and to provide a private interface for users to view their match. By automating the matching process, I was able to make our holiday gift exchange more effective.\n\nRecently, I have upgraded the UI to be more user friendly and visually appealing, making it even easier for my family to use and enjoy the Secret Santa tradition.",
  ...
  },
  {
    ...
    description:
      "Developed an automation bot that scans an email account for bank statements, downloads statements, and parses data into an Excel sheet stored in Office 365. This tool streamlines budgeting across multiple bank accounts by tracking dates, purchase descriptions, and amounts in one central location.",
    originStory:
      "When I was hoping to get an internship my junior year of college, I had an interview scheduled a few weeks out for an RPA intern position.  So during the winter break, I took multiple courses on UiPath on LinkedIn Learning and UiPath Academy to prepare for the interview.  Once I completed those, I wanted to experiment with building some automations on my own.\n\nDuring this time, I was filling out my budgeting excel spreadsheet weekly to keep up with my finance.  I thought it would be a good idea to automate this process and make it more efficient.\n\nI built this budgeting automation to save time and reduce the manual effort involved in tracking my finances. By automating the retrieval and parsing of bank statements, I was able to maintain an up-to-date budget without the hassle of manual data entry, allowing me to focus more on analyzing my spending patterns and making informed financial decisions.",
  ...
  },
  {
    ...
    description:
      "Developed a process for a friend that is a basketball coach that analyzes basketball game data by tracking points scored and allowed for each lineup throughout game. The tool then groups combinations of size 2, 3, 4, and 5 to identify the most effective lineups, helping optimize team performance.",
    originStory:
      "During my junior year of college, my roommate's best friend from high school was an assistant basketball coach at an Akron College.  He called my roommate one night asking if any of us could help him out.  He was tasked with analyzing which lineups were most effective for the team, he had all the data provided to him but he didn't know how to aggregate it programmatically.\n\nI offered to help and built some code to the lineup optimization processing. After I built the tool, I sent him the code and run instructions and he was able to use it to analyze the game data and identify the most effective lineups for his team.",
...

  {
    ...
    originStory:
      "During my senior year of college, TikTok and Instagram Reels were becoming increasingly popular.  Even really simple things like story telling videos layered over gameplay.  I wanted to experiment with building a content creation bot that could automate the process of creating and uploading videos.\n\nI built this Reddit Stories bot to retrieve top daily Reddit stories, convert them to speech, and pair the audio with engaging Minecraft speed-run footage. By automating the entire pipeline from content retrieval to video creation and distribution, I was able to create a unique and entertaining social media presence that gained traction and provided a fun creative outlet for me.",
  ...
  },
  {
    ...
    originStory:
      "On my team, testing often means pulling production queue inputs and loading them into our QA queues. Our old process relied on custom Excel VBA functions to parse the export data and loop through every row — slow, fragile, and something only a couple of people on the team really understood.\n\nI built this tool to replace that entire workflow: a teammate just drops in the production export, and the app flattens the nested JSON fields and returns a clean file ready to upload straight into the QA queue. What used to take a custom script and manual looping now takes one drag-and-drop.",
  ...
  },
  {
    ...
    originStory:
      "When I first started building my personal website, it was all plain HTML — I didn't know TypeScript or any frontend framework yet. Rather than reaching for a library to make it feel more interesting, I set myself a learning goal: find out what HTML itself was actually capable of.\n\nI built this tool specifically as a research project, digging up lesser-known HTML elements and attributes that could add interactivity and polish without a single line of JavaScript. It ended up teaching me more about the platform's built-in capabilities than any tutorial would have.",
