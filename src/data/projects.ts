...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description: "IN PROGRESS - Personal assistant powered by Generative AI",
  ...
  {
    title: "Run Genius",
    description: "IN PROGRESS - AI-powered running assistant mobile app",
    technologies: ["Gemini CLI", "SwiftUI", "XCode"],
    tags: ["Swift", "Mobile", "AI", "In Progress"],
    github_link: "",
    image: "runGenius.png",
    page: "",
    is_interactive: false,
